...
| 11 | `#account` → **redirect `#profile`** (R9a v3.198; renderAccountPage retired defined-but-unrouted — S-B deletion debt) · **S-B SWEEP promoted to lead (re-plan 2026-08-08); this dead-code deletion is the sweep's marquee, in progress under THE DELETION RULE (one census + commit per region)** | — merged into #14 | — | — | — | — |

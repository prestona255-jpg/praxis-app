...
- `docs/archive/praxis-book-app-living-document.html` — **ARCHIVED** narrative (historical Stage-3 living document; stale — **not** current architecture; see the banner at its top).
